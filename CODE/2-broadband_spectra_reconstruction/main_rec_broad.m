%% Demonstration of spectral reconstruction (broadband)
% Version: 4.1
% Date: 2024.12
...
%% ----- 1. load data ----- %%
    ...
    % photocurrent
    load('./data_broadband_spectra/Input_dataset.mat','I')
    
    % spectral response matrix
    load('./data_broadband_spectra/Response_matrix.mat','R')
    
    % spectra ground truth
    load('./data_broadband_spectra/Spectra_GT.mat','Spectra_GT')
...
%% ----- 3. data visulization ----- %%
    ...
    plot_spectra_index = 10000; % choose a index from 1-10,000
    ...
    saveas(gcf,'./figs_broadband_spectra/ground_truth.png')
    ...
    xlabel('Spectral index')
    ylabel("Intensity (a.u.)")
    saveas(gcf,'./figs_broadband_spectra/reconstructed.png')
